...
import com.spboot.merge.activi.service.ActiviService;
import com.spboot.merge.user.dto.SysRole;
import com.spboot.merge.user.dto.SysUser;
import com.spboot.merge.user.dto.SysUserRole;
import com.spboot.merge.user.service.SysUserRoleService;
import com.spboot.merge.user.service.SysUserService;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        logger.info("info! 用户登录: " + username);
